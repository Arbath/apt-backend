...
pub async fn get_recognition_detail_hand(
    ...
    let response_data = service.get_recongnition_detail(recognition_id).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn search_recognition_hand(
    ValidatedQuery(query): ValidatedQuery<RecognitionLecturerQuery>,
    uri: Uri,
    AuthUser(_): AuthUser,
    service: AppRecongnitionService,
) -> Result<impl IntoResponse, ApiError> {
    ...
    let (response_data, total_items) = service.search_recongnition(query).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn create_recognition_hand(
    ...
    let response_data = service.create_recognition(user, data).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn update_recognition_hand(
    ...
    let response_data = service.update_recognition(user, recognition_id, data).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn delete_recognition_hand(
    ...
    let response_data = service.delete_recongnition(user, recognition_id).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn approve_recognition_hand(
    ...
    let response_data = service.approve_recongnition(user, recognition_id).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn reject_recognition_hand(
    ...
    let response_data = service.reject_recongnition(user, recognition_id).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn get_all_recognition_cat_hand(
    ...
    let response_data = service.find_all_category().await.map_err(|e|e.with_path(&uri))?;
...
pub async fn get_recognition_cat_detail_hand(
    ...
    let response_data = service.find_category_id(category_id).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn get_recognition_cat_name_hand(
    ...
    let response_data = service.find_category_name(&category_name).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn create_recognition_cat_hand(
    ...
    let response_data = service.create_category(data).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn update_recognition_cat_hand(
    ...
    let response_data = service.update_category(category_id, data).await.map_err(|e|e.with_path(&uri))?;
...
pub async fn delete_recognition_cat_hand(
    ...
    let response_data = service.delete_category(category_id).await.map_err(|e|e.with_path(&uri))?;
